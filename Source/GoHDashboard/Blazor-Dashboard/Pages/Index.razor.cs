...
namespace Blazor_Dashboard.Pages
{
    public partial class Index : ComponentBase
    {
        ...
        Layout _averageCapitalLayout = CreateLayout("The average maintenance costs and rent of 100 scenarios.");
        ...
        Layout _averageSolvencyLayout = CreateLayout("The average solvency ratio of 100 scenarios.");
        ...
        Layout _debtLayout = CreateLayout("The average debt of 100 scenarios.");
